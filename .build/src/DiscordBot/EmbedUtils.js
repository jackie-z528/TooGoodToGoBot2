...
exports.buildRestockEmbed = void 0;
const discord_js_1 = require("discord.js");
const buildRestockEmbed = (bucketItem) => {
    ...
    return new discord_js_1.EmbedBuilder()
        ...
        .addFields({ name: "New Stock", value: items_available.toString(), inline: true }, { name: "Price", value: price, inline: true })
        .setImage(cover_picture.current_url);
};
exports.buildRestockEmbed = buildRestockEmbed;

...
export const loginCommand: Command = {
  data: new SlashCommandBuilder()
    .setName("login")
    .setDescription("Login with your TooGoodToGo email")
  ...
  async execute(interaction: ChatInputCommandInteraction) {
    ...
    try {
      ...
      await interaction.reply(
        `Login request sent to ${email}, /continue-login after clicking the login button in your email in a browser. DO NOT CLICK THE LINK ON YOUR PHONE.`
      );
    } catch (err) {
...
export const continueLoginCommand: Command = {
  data: new SlashCommandBuilder()
    .setName("continue-login")
    .setDescription("Continue login after clicking the link sent to your email")
    .addStringOption((option) =>
      option
        .setName("email")
        .setDescription("Email to login with")
